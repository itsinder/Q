...
g_qtypes.I2 = { short_code = "I2", width = 2, ctype = "int16_t", txt_to_ctype = "txt_to_I2", ctype_to_txt = "I2_to_txt", max_length="8" }
g_qtypes.I4 = { short_code = "I4", width = 4, ctype = "int32_t", txt_to_ctype = "txt_to_I4", ctype_to_txt = "I4_to_txt", max_length="13" }
g_qtypes.I8 = { short_code = "I8", width = 8, ctype = "int64_t", txt_to_ctype = "txt_to_I8", ctype_to_txt = "I8_to_txt", max_length="22" }
g_qtypes.F4 = { short_code = "F4", width = 4, ctype = "float", txt_to_ctype = "txt_to_F4", ctype_to_txt = "F4_to_txt", max_length="33" }
g_qtypes.F8 = { short_code = "F8", width = 8, ctype = "double", txt_to_ctype = "txt_to_F8", ctype_to_txt = "F8_to_txt", max_length="65" }
