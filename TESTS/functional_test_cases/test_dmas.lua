...
assert(n1:tonum() == a:length())
assert(n1:tonum() == b:length())
assert(n1:tonum() == c:length())
...
local dmas2 = Q.sum(cmp_result):eval()
assert(dmas2:tonum() == a:length())
assert(dmas2:tonum() == b:length())
assert(dmas2:tonum() == d:length())
