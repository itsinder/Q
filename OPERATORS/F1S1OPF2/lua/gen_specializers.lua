...
local tbl2 = 'local code_for_ops = {I1 = "(int8_t)", I2 = "(int16_t)", I4 = "(int32_t)", I8 = "(int64_t)", F4 = "", F8 = ""}\n'
local z = x
local w = ")\n" .. tbl .. tbl2
y = string.gsub(z, "[)]", w)
y = string.gsub(y, "<<operator>>", "abs")
y = string.gsub(y, "<<c_code_for_operator>>", "c = ".. '".. code_for_ops[in_qtype] .. funcs[in_qtype] .."'.."(a);")
y = string.gsub(y, "<<out_qtype>>", "in_qtype")
