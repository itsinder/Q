...
return { 
  ...
  { meta = "gm_valid_I1.lua", data = "I1_valid.csv" },
  { meta = "gm_valid_I2.lua", data = "I2_valid.csv" },
  { meta = "gm_valid_I4.lua", data = "I4_valid.csv" }, 
  { meta = "gm_valid_I8.lua", data = "I8_valid.csv" },
  { meta = "gm_valid_F4.lua", data = "F4_valid.csv" },
  { meta = "gm_valid_F8.lua", data = "F8_valid.csv" },
  { meta = "gm_valid_SC.lua", data = "SC_valid.csv" },
  { meta = "gm_valid_SV.lua", data = "SV_valid.csv" },
