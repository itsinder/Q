local function qsort2_asc(x, y, ordr)
  ...
  local spfn = require("Q/OPERATORS/SORT2/lua/qsort2_asc_specialize" )
...
return require('Q/q_export').export('qsort2_asc', qsort2_asc)
