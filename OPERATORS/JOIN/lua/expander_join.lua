...
--    didx[0] = 0
    ...
    repeat
      ...
      print(func_name)
      local status = qc[func_name](join_type, casted_b_chunk, casted_a_chunk, aidx, a_len, casted_out_buf, casted_out_nn_buf, casted_c_buf, c_len)
    ...
    until ( c_len == sz_out)
    print(dst_fld[0], dst_fld[1],dst_fld[2])
    return dst_lnk:length(), dst_fld, nil
  end
