...
return { 
  ...
  { meta = "gm_single_col.lua", data ="single_col_file.csv", csv_file = "single_col.csv", category = "category1", name= "single_col", output_regex = "1001\n1002\n1003\n1004\n" },
  -- testcase for printing multiple column contents
  { meta = "gm_multi_col.lua",  data ="multi_col_file.csv", csv_file = "multi_col.csv", category = "category1", name= "multiple_col", output_regex = "1001,1\n1002,2\n1003,3\n1004,4\n" },
  -- checking for valid I1 column contents
  { meta = "gm_print_I1.lua", data ="sample_I1.csv", csv_file = "print_I1.csv", category = "category1", name= "print_I1_type", output_regex = "12\n123\n50\n111\n" },
  -- checking for valid I2 column contents
  { meta = "gm_print_I2.lua", data ="sample_I2.csv", csv_file = "print_I2.csv", category = "category1", name= "print_I2_type", output_regex = "1002\n123\n2312\n2131\n" },
  -- checking for valid I4 column contents
  { meta = "gm_print_I4.lua", data ="sample_I4.csv", csv_file = "print_I4.csv", category = "category1", name= "print_I4_type", output_regex = "1002\n123\n2312\n2131\n" },
  -- checking for valid I8 column contents
  { meta = "gm_print_I8.lua", data ="sample_I8.csv", csv_file = "print_I8.csv", category = "category1", name= "print_I8_type", output_regex = "1002\n123\n2312\n2131\n" },
  -- checking for valid SV column contents
  { meta = "gm_print_SV.lua", data ="sample_varchar.csv", csv_file = "print_SV.csv", category = "category1", name= "print_SV_type", output_regex = "Sample\nString\nFor\nVarchar\n" },
  -- checking for valid SC column contents
  { meta = "gm_print_SC.lua", data ="fix_size_string.csv", csv_file = "print_SC.csv", category = "category1", name= "print_SC_type", output_regex = "Hiihello\nbye\n" },
