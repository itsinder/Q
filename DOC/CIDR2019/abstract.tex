...
design and development of Q, an analytical database. It has its own language with an extensible set of operators operators for the manipulation of data.  The language is inspired by
...
with enough performance to make coding and debugging interactive.
