...
By using a simple data model that is transparent to the programmer, Q allows the
porgrammer to blur the line between what gets done by Lua and what gets done by
C.
