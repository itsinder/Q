...
I propose we adopt the convention that the above kind of require’s occur {\bf before} the start of the function definition.
While it can be done anywhere, standardization is better to read and maintain
the code.
