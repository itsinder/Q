...
The other central requirement guiding Q's development is that development and
maintenance of code, (especially when it involves trial and error, changing
requirements, etc.) is as important as run time performance.  To support this:
(a) we have an extreme focus on performance to support interactive development
and debugging (b) added a Python interface so that data sciensists can use their
